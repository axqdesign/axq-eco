...
import { IconAccessible, IconAccessibleFilled, createReactComponent } from "./src/axqdesign-icons-react"
import type { AXQIcon } from "./src/types"
...
describe("React Icon component", () => {
  ...
  it('should apply all classNames to the element', () => {
    ...
    expect(container.firstChild).toHaveClass('axqdesign-icon');
    expect(container.firstChild).toHaveClass('axqdesign-icon-accessible');
  });
  ...
  it('should match AXQIcon type', () => {
    expectTypeOf(IconAccessible).toMatchTypeOf<AXQIcon>();
    expectTypeOf(IconAccessibleFilled).toMatchTypeOf<AXQIcon>();
  });
  ...
  it("should match snapshot", () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(`
      <svg xmlns="http://www.w3.org/2000/svg"
           ...
           class="axqdesign-icon axqdesign-icon-accessible "
      >
