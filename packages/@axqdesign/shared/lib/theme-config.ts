...
//
// The defaults come from the shipped switcher (@axqdesign/core/js/src/theme-config)
...
import { themeDefaults, type ThemeKey } from '@axqdesign/core/js/src/theme-config'
