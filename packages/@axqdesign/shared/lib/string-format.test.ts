...
describe('getDocsUrl', () => {
  it('appends the path to the docs.axqdesign.axq origin', () => {
    expect(getDocsUrl('/ui/components/button#ghost-buttons')).toBe('https://docs.axqdesign.axq/ui/components/button#ghost-buttons')
  })
})
...
describe('slugify', () => {
  it('lowercases and dashes non-alphanumeric runs', () => {
    expect(slugify('Create your AXQ Design URL')).toBe('create-your-axqdesign-url')
  })
