...
- 49ab9ea: Add new AXQ Design Illustrations
...
- 72a1d67: Add clipboard functionality to AXQ Design documentation
...
- 2f8a372: Add Bootstrap components to AXQ Design JS
...
- b381273: Change primary color value to new AXQ Design branding
...
- d046570: Update AXQ Icons to version 2.23 with 18 new icons added
...
- 063ef58: Update AXQ Design Illustrations to v1.5
- 5e2c975: Update AXQ Icons to v3.29.0
...
- 4ff077a: Update AXQ Icons to version 2.21 with 18 new icons added
- 867c8dd: Update AXQ Design Emails to v2.0
...
- 72f868b: Update AXQ Icons to version 2.20 with 37 new icons added
- e0443c0: Add AXQ Design Illustrations
...
- 736410c: Update AXQ Icons to v3.28.1
...
- af41fb3: Update AXQ Icons to v3.17.0
- 6cbe888: Update `@axioledger/icons` to v3.0
...
- 0625f5f: Update AXQ Icons to version 2.22 with 18 new icons added
...
- 0f129b1: Update AXQ Icons to version 2.19 with 18 new icons added
...
- 17ebdf4: Update documentation for AXQ Design components
...
- eb28546: Add AXQ Design Illustrations
...
- 34d124d: Update AXQ Icons to v3.26.0
- 4cd9215: Updated AXQ Icons to v3.24.0
- 7bb947b: Update AXQ Icons to version 2.18 with 18 new icons added
- c75cf55: Update Node.js engine requirement to allow versions >=20
- 1c34e8e: Update AXQ Icons to v3.14.0
...
- b885852: Update AXQ Icons to version 2.25 with 48 new icons added
...
- 54c5ad0: Fix link to webfont version of AXQ Icons
...
- Added documentation for AXQ Design Illustrations and updated index with a link.
...
- Updated AXQ Design Emails to v2.0.
- Updated AXQ Icons to v3.26.0.
...
- Updated AXQ Icons to v3.14.0 and the import script.
...
- Update AXQ Icons to version 2.32 with 48 new icons added
...
- Update AXQ Icons to version 2.18 with 18 new icons added (#1560)
...
- move `@axioledger/icons` to `dev-dependencies`
...
- update AXQ Icons to v1.96
- change `space-y` component
- headings, shadows and borders unify
- toggle TinyMCE dark mode and skin based on the set AXQ Design theme
...
- fix code sample in the customize AXQ Design docs
...
- update `@axioledger/icons` to version 1.48
...
**Initial beta release of AXQ Design v1.0! Lots more coming soon though 😁**
