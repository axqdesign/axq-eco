...
import { IconAccessible, IconAccessibleFilled } from './src/axqdesign-icons-astro';
...
describe('Astro Icon component', () => {
  ...
  it('should apply default attributes', async () => {
    ...
    expect(tag).toContain('class="axqdesign-icon axqdesign-icon-accessible"');
  });
  ...
  it('should append a custom class', async () => {
    ...
    expect(tag).toContain('class="axqdesign-icon axqdesign-icon-accessible test-class"');
  });
