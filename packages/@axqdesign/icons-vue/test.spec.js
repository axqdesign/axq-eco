...
import { IconAccessible, IconAccessibleFilled } from "./src/axqdesign-icons-vue.ts"
...
describe("Vue Icon component", () => {
  ...
  it('should add a class to the element', () => {
    ...
    expect(svg).toHaveClass('axqdesign-icon')
    expect(svg).toHaveClass('axqdesign-icon-accessible')
  })
  ...
  it('should pass children to the icon slot', () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(`"<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="axqdesign-icon axqdesign-icon-accessible"><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"></path><path d="M10 16.5l2 -3l2 3m-2 -3v-2l3 -1m-6 0l3 1"></path><circle cx="12" cy="7.5" r=".5" fill="currentColor"></circle><text>Hello World</text></svg>"`);
  });
