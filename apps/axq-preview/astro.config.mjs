  ...
  return {
    ...
    hooks: {
      'astro:build:done': async ({ dir, logger }) => {
        ...
        // (demo css/js and @axioledger/core's dist, including vendored libs) — not pages, and
...
export default defineConfig({
  ...
  integrations: [
    copyAssets({
      ...
      copies: [
        {
          // @axioledger/core dist (css/js/fonts/img/libs).
          // Fallback keeps current assets if core rebuilds dist mid-copy in turbo dev.
          from: path('./node_modules/@axioledger/core/dist'),
          to: path('./public/dist'),
          label: '@axioledger/core',
        ...
        // favicons (source assets of @axioledger/preview)
        { from: path('./assets/favicon.ico'), to: path('./public/favicon.ico'), label: '@axioledger/preview' },
        { from: path('./assets/favicon-dev.ico'), to: path('./public/favicon-dev.ico'), label: '@axioledger/preview' },
      ],
